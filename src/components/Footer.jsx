    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <Link href="#" class="flex items-center">
                  ...
                  <span class="self-center text-2xl font-semibold whitespace-nowrap ">CarPool</span>
              </Link>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 font-medium">
                      <li class="mb-4">
                          <Link href="#" class="hover:underline">CarPool</Link>
                      </li>
                      <li>
                          <Link href="#" class="hover:underline">API Ninja API</Link>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link href="#" class="text-gray-500 hover:text-gray-900 ms-5">
