...
export default function Filters({filterType, options}: FiltersProps) {
    ...
    return (
        <div className='m-3 m relative '>
            ...
            onClick={handleClick}>
                <ul  className="py-2 text-sm text-gray-700 max-h-48 " aria-labelledby="dropdownDefaultButton">
