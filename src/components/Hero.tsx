...
export default function Hero() {
    ...
    return (
        <div className='w-fullflex-1 md:flex h-screen'>
            ...
            <div
                className="right w-full md:w-2/3 h-[75vh] md:h-screen flex items-center">
                <div className=' flex justify-end'>
                    <Image src={'/hero2.png'} alt='hero image' width={200000} height={100000}
                        className='w-4/5 md:w-[90%] mr-5' />


                    <div className='hero__image-overlay  md:flex'></div>
